...
database = PostgresqlDatabase('clinical_trial', **{'host': 'postgres-prod.cnw0jywsbq0l.us-west-2.rds.amazonaws.com', 'port': 5432, 'user': 'kyclark', 'password': 'mHo%90^NOMgT'})
...
class StudyOutcome(BaseModel):
    ...
    class Meta:
        ...
        indexes = (
            (('study', 'outcome_type', 'measure', 'time_frame', 'description'), False),
        )
